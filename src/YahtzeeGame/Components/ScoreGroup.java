...
public class ScoreGroup extends JPanel implements Resettable
{
	...
	score = new JLabel();
	score.setFont(new Font(score.getFont().getFontName(), Font.BOLD, score.getFont().getSize()));
	...
	if (!chosen)
	{
	    ...
	    {
		this.score.setText(Integer.toString(category.getYahtzeeBonusOverrideScore(dice)));
	    }
	    else
	    {
